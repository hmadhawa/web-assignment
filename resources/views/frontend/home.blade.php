            ...
            <div class="carousel-inner" role="listbox">
               ...
               <div class="carousel-item active" style="background-image: url('frontend/images/slider-01.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h3>Protect Our Earth...</h3>
                     <p>Do you part to save the planet. Every action count!Then Signup with us.</p>
                  </div>
               </div>
               <!-- Slide Two - Set the background image for this slide in the line below -->
               <div class="carousel-item" style="background-image: url('frontend/images/slider-02.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h3>Mother Earth needs You</h3>
               ...
               <div class="carousel-item" style="background-image: url('frontend/images/slider-03.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h3>Nature Beauty </h3>
                     <p>All the peoples duty to save the mother nature.</p>
                  </div>
               </div>
            </div>
